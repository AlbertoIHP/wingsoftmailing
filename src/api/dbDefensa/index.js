...
export dbDefensa, { schema } from './model'

const router = new Router()
const { juzgado, procurador, rol, caratulado, cliente, fecha_ingreso, estado, url_causa } = schema.tree
 ...
 */
router.post('/',
  body({ juzgado, procurador, rol, caratulado, cliente, fecha_ingreso, estado, url_causa }),
  create)
